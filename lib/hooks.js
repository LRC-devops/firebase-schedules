...
export async function useBatchSubmitHandler(newSessions) {
  // e.preventDefault();
  // setIsLoading(true);
  // setIsSubmit(true);

  // console.log("enter batchSubmit with", newSessions, e);
  ...
  try {
    ...
    if (newSessions.length === 1) {
      ...
      for (let i = 0; i < newSessions.length; i++) {
        ...
        // console.log("batch.set in for loop", newSessions[i]);
      }
    }
